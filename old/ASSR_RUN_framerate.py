...
frame_duration = 1.0/monitor_rr # duration of trigger pixel in seconds, set to 1 frame for now, can be adjusted if needed

n_frames_total = round(ARROW_DUR / frame_duration)
...
core.wait(1.0 - 2*frame_duration) 
