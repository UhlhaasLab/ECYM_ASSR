...
def preload_stim(win, stimulipath, subjectpath, vpdevice, dB_SL=60):
    if MRS == 0:
        # ======= AUDITORY
        FS = 48000 
    ...
    if MRS == 1:
        ...
        audio_reg = assign_subject_gains( audio_reg,    threshold_linear=thr_lin,    per_tone_dBSL={'clicktrain': dB_SL})
        print(audio_reg)        
...
#https://docs.vpixx.com/vocal/configuring-inputs-and-outputs-with-schedules
